...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "TestApp.controller.TodoController": [],
  "TestApp.model.QuoteModel": [],
  "TestApp.model.TodoModel": [],
  "TestApp.store.QuoteStore": [],
  "TestApp.store.TodoStore": [],
  "TestApp.view.InformationView": [],
  "TestApp.view.LocationView": [],
  "TestApp.view.Main": [],
  "TestApp.view.SettingsView": [],
  "TestApp.view.TodoForm": [],
  "TestApp.view.TodoView": []
});
